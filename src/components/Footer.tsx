        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Auto Insurance</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Home Insurance</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Life Insurance</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Health Insurance</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Business Insurance</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Travel Insurance</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">File a Claim</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Policy Management</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Payment Center</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Help Center</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Contact Agent</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Forms & Documents</a></li>
            </ul>
          </div>
